...
#Preview("Automatic Colors") {
    @Previewable @State var url: URL = URL(string: "https://local.goldilocksdigital.xyz/12346")!

    VStack(spacing: 40.0) {
        QRCodeView(url: url, centerImage: Image(BrandConfig.shared.assets.logoImageName))
    }
}
